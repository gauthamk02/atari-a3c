...
def train(shared_model, shared_optimizer, rank, args, info):
    ...
    for i in range(args['steps']): # openai baselines uses 40M frames...we'll use 80M
        ...
        if i % 100 == 0: # print info ~ every minute
...
if __name__ == "__main__":
    ...
    args = get_args()
    args['save_dir'] = 'breakout-v4/' # keep the directory structure simple
